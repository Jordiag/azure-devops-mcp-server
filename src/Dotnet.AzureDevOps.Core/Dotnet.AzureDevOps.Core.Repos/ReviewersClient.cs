...
namespace Dotnet.AzureDevOps.Core.Repos
{
    ...
    {
        public static async Task<(string guid, string name)> GetUserIdFromEmailAsync(string organizationUrl, string pat, string email, CancellationToken cancellationToken = default)
        {
