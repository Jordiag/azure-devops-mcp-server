...
namespace Dotnet.AzureDevOps.Mcp.Server.Tools
{
    ...
    public class BoardsTools(IWorkItemsClient workItemsClient, ILogger<BoardsTools> logger)
    {
        ...
        public async Task<bool> IsSystemProcessAsync() =>
            (await _workItemsClient.IsSystemProcessAsync()).EnsureSuccess(_logger);
        ...
        public async Task<int> GetWorkItemCountAsync(string wiql) =>
            (await _workItemsClient.GetWorkItemCountAsync(wiql)).EnsureSuccess(_logger);
        ...
        public async Task<WorkItemType> GetWorkItemTypeAsync(string projectName, string workItemTypeName) =>
            (await _workItemsClient.GetWorkItemTypeAsync(projectName, workItemTypeName)).EnsureSuccess(_logger);
        ...
        public async Task<WorkItem> SetCustomFieldAsync(int workItemId, string fieldName, string value) =>
            (await _workItemsClient.SetCustomFieldAsync(workItemId, fieldName, value)).EnsureSuccess(_logger);
        ...
        public async Task<object> GetCustomFieldAsync(int workItemId, string fieldName) =>
            (await _workItemsClient.GetCustomFieldAsync(workItemId, fieldName)).EnsureSuccess(_logger);
        ...
        public async Task<bool> BulkUpdateWorkItemsAsync(IEnumerable<(int id, WorkItemCreateOptions options)> updates) =>
            (await _workItemsClient.BulkUpdateWorkItemsAsync(updates)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<int>> CreateWorkItemsMultipleCallsAsync(string workItemType, IEnumerable<WorkItemCreateOptions> items) =>
            (await _workItemsClient.CreateWorkItemsMultipleCallsAsync(workItemType, items)).EnsureSuccess(_logger);
        ...
        public async Task<Guid> AddAttachmentAsync(int workItemId, string filePath) =>
            (await _workItemsClient.AddAttachmentAsync(workItemId, filePath)).EnsureSuccess(_logger);
        ...
        public async Task<Stream> GetAttachmentAsync(string projectName, Guid attachmentId) =>
            (await _workItemsClient.GetAttachmentAsync(projectName, attachmentId)).EnsureSuccess(_logger);
        ...
        public async Task<bool> AddCommentAsync(int workItemId, string projectName, string comment) =>
            (await _workItemsClient.AddCommentAsync(workItemId, projectName, comment)).EnsureSuccess(_logger);
        ...
        public async Task<IEnumerable<WorkItemComment>> GetCommentsAsync(int workItemId) =>
            (await _workItemsClient.GetCommentsAsync(workItemId)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WorkItemUpdate>> GetHistoryAsync(int workItemId) =>
            (await _workItemsClient.GetHistoryAsync(workItemId)).EnsureSuccess(_logger);
        ...
        public async Task<bool> AddLinkAsync(int workItemId, int targetWorkItemId, string linkType) =>
            (await _workItemsClient.AddLinkAsync(workItemId, targetWorkItemId, linkType)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WorkItemRelation>> GetLinksAsync(int workItemId) =>
            (await _workItemsClient.GetLinksAsync(workItemId)).EnsureSuccess(_logger);
        ...
        public async Task<bool> RemoveLinkAsync(int workItemId, string linkUrl) =>
            (await _workItemsClient.RemoveLinkAsync(workItemId, linkUrl)).EnsureSuccess(_logger);
        ...
        public async Task<bool> LinkWorkItemToPullRequestAsync(string projectId, string repositoryId, int pullRequestId, int workItemId) =>
            (await _workItemsClient.LinkWorkItemToPullRequestAsync(projectId, repositoryId, pullRequestId, workItemId)).EnsureSuccess(_logger);
        ...
        public async Task<bool> CreateSharedQueryAsync(string projectName, string queryName, string wiql) =>
            (await _workItemsClient.CreateSharedQueryAsync(projectName, queryName, wiql)).EnsureSuccess(_logger);
        ...
        public async Task<bool> DeleteSharedQueryAsync(string projectName, string queryName) =>
            (await _workItemsClient.DeleteSharedQueryAsync(projectName, queryName)).EnsureSuccess(_logger);
        ...
        public async Task<QueryHierarchyItem> GetQueryAsync(string projectName, string queryIdOrPath, QueryExpand? expand = null, int depth = 0, bool includeDeleted = false, bool useIsoDateFormat = false) =>
            (await _workItemsClient.GetQueryAsync(projectName, queryIdOrPath, expand, depth, includeDeleted, useIsoDateFormat)).EnsureSuccess(_logger);
        ...
        public async Task<WorkItemQueryResult> GetQueryResultsByIdAsync(Guid queryId, TeamContext teamContext, bool? timePrecision = false, int top = 50) =>
            (await _workItemsClient.GetQueryResultsByIdAsync(queryId, teamContext, timePrecision, top)).EnsureSuccess(_logger);
        ...
        public async Task<PredefinedQuery> ListMyWorkItemsAsync(string queryType = "assignedtome", int? top = null, bool? includeCompleted = null, object? userState = null) =>
            (await _workItemsClient.ListMyWorkItemsAsync(queryType, top, includeCompleted, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<BoardReference>> ListBoardsAsync(TeamContext teamContext, object? userState = null) =>
            (await _workItemsClient.ListBoardsAsync(teamContext, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<BoardColumn>> ListBoardColumnsAsync(TeamContext teamContext, Guid board, object? userState = null) =>
            (await _workItemsClient.ListBoardColumnsAsync(teamContext, board, userState)).EnsureSuccess(_logger);
        ...
        public async Task<Board> ExportBoardAsync(TeamContext teamContext, string boardId) =>
            (await _workItemsClient.ExportBoardAsync(teamContext, boardId)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<BacklogLevelConfiguration>> ListBacklogsAsync(TeamContext teamContext, object? userState = null) =>
            (await _workItemsClient.ListBacklogsAsync(teamContext, userState)).EnsureSuccess(_logger);
        ...
        public async Task<BacklogLevelWorkItems> ListBacklogWorkItemsAsync(TeamContext teamContext, string backlogId, object? userState = null) =>
            (await _workItemsClient.ListBacklogWorkItemsAsync(teamContext, backlogId, userState)).EnsureSuccess(_logger);
        ...
        public async Task<TeamFieldValues> ListAreasAsync(TeamContext teamContext) =>
            (await _workItemsClient.ListAreasAsync(teamContext)).EnsureSuccess(_logger);
        ...
        public async Task<TeamSettingsIteration> GetTeamIterationAsync(TeamContext teamContext, Guid iterationId, object? userState = null) =>
            (await _workItemsClient.GetTeamIterationAsync(teamContext, iterationId, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<TeamSettingsIteration>> GetTeamIterationsAsync(TeamContext teamContext, string timeframe, object? userState = null) =>
            (await _workItemsClient.GetTeamIterationsAsync(teamContext, timeframe, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<TeamSettingsIteration>> ListIterationsAsync(TeamContext teamContext, string? timeFrame = null, object? userState = null) =>
            (await _workItemsClient.ListIterationsAsync(teamContext, timeFrame, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WorkItemClassificationNode>> CreateIterationsAsync(string projectName, IEnumerable<IterationCreateOptions> iterations) =>
            (await _workItemsClient.CreateIterationsAsync(projectName, iterations)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<TeamSettingsIteration>> AssignIterationsAsync(TeamContext teamContext, IEnumerable<IterationAssignmentOptions> iterations) =>
            (await _workItemsClient.AssignIterationsAsync(teamContext, iterations)).EnsureSuccess(_logger);
        ...
        public async Task<IterationWorkItems> GetWorkItemsForIterationAsync(TeamContext teamContext, Guid iterationId, object? userState = null) =>
            (await _workItemsClient.GetWorkItemsForIterationAsync(teamContext, iterationId, userState)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> ExecuteBatchAsync(IEnumerable<WitBatchRequest> requests) =>
            (await _workItemsClient.ExecuteBatchAsync(requests)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> UpdateWorkItemsBatchAsync(IEnumerable<(int id, WorkItemCreateOptions options)> updates, bool suppressNotifications = true, bool bypassRules = false) =>
            (await _workItemsClient.UpdateWorkItemsBatchAsync(updates, suppressNotifications, bypassRules)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> LinkWorkItemsBatchAsync(IEnumerable<(int sourceId, int targetId, string relation)> links, bool suppressNotifications = true, bool bypassRules = false) =>
            (await _workItemsClient.LinkWorkItemsBatchAsync(links, suppressNotifications, bypassRules)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> CloseWorkItemsBatchAsync(IEnumerable<int> workItemIds, string closedState = "Closed", string? closedReason = "Duplicate", bool suppressNotifications = true, bool bypassRules = false) =>
            (await _workItemsClient.CloseWorkItemsBatchAsync(workItemIds, closedState, closedReason, suppressNotifications, bypassRules)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> CloseAndLinkDuplicatesBatchAsync(IEnumerable<(int duplicateId, int canonicalId)> pairs, bool suppressNotifications = true, bool bypassRules = false) =>
            (await _workItemsClient.CloseAndLinkDuplicatesBatchAsync(pairs, suppressNotifications, bypassRules)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WorkItem>> GetWorkItemsBatchByIdsAsync(IEnumerable<int> ids, WorkItemExpand expand = WorkItemExpand.All, IEnumerable<string>? fields = null) =>
            (await _workItemsClient.GetWorkItemsBatchByIdsAsync(ids, expand, fields)).EnsureSuccess(_logger);
        ...
        public async Task<IReadOnlyList<WitBatchResponse>> LinkWorkItemsByNameBatchAsync(IEnumerable<(int sourceId, int targetId, string type, string? comment)> links, bool suppressNotifications = true, bool bypassRules = false) =>
            (await _workItemsClient.LinkWorkItemsByNameBatchAsync(links, suppressNotifications, bypassRules)).EnsureSuccess(_logger);
    }
}
