...
public class ProjectSettingsTools(IProjectSettingsClient projectSettingsClient, ILogger<ProjectSettingsTools> logger)
{
    ...
    public async Task<bool> CreateTeamIfDoesNotExistAsync(string teamName, string teamDescription, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.CreateTeamIfDoesNotExistAsync(teamName, teamDescription, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<Guid> GetTeamIdAsync(string teamName, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.GetTeamIdAsync(teamName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<List<WebApiTeam>> GetAllTeamsAsync(CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.GetAllTeamsAsync(cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> UpdateTeamDescriptionAsync(string teamName, string newDescription, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.UpdateTeamDescriptionAsync(teamName, newDescription, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteTeamAsync(Guid teamGuid, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.DeleteTeamAsync(teamGuid, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> CreateInheritedProcessAsync(string newProcessName, string description, string baseProcessName, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.CreateInheritedProcessAsync(newProcessName, description, baseProcessName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteInheritedProcessAsync(string processId, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.DeleteInheritedProcessAsync(processId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<string> GetProcessIdAsync(string processName, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.GetProcessIdAsync(processName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<Guid> CreateProjectAsync(string projectName, string description, string processId, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.CreateProjectAsync(projectName, description, processId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<TeamProject> GetProjectAsync(string projectName, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.GetProjectAsync(projectName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteProjectAsync(Guid projectId, CancellationToken cancellationToken = default) =>
        (await _projectSettingsClient.DeleteProjectAsync(projectId, cancellationToken)).EnsureSuccess(_logger);
}
