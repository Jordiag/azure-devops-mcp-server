...
public class ArtifactsTools(IArtifactsClient artifactsClient, ILogger<ArtifactsTools> logger)
{
    ...
    public async Task<Guid> CreateFeedAsync(FeedCreateOptions options) =>
        (await _artifactsClient.CreateFeedAsync(options)).EnsureSuccess(_logger);
    ...
    public async Task<bool> UpdateFeedAsync(Guid feedId, FeedUpdateOptions options) =>
        (await _artifactsClient.UpdateFeedAsync(feedId, options)).EnsureSuccess(_logger);
    ...
    public async Task<Feed> GetFeedAsync(Guid feedId) =>
        (await _artifactsClient.GetFeedAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<Feed>> ListFeedsAsync() => 
        (await _artifactsClient.ListFeedsAsync()).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteFeedAsync(Guid feedId) =>
        (await _artifactsClient.DeleteFeedAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<Package>> ListPackagesAsync(Guid feedId) => 
        (await _artifactsClient.ListPackagesAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<Package> GetPackageVersionAsync(Guid feedId, string packageName, string version) =>
        (await _artifactsClient.GetPackageVersionAsync(feedId, packageName, version)).EnsureSuccess(_logger);
    ...
    public async Task<bool> UpdatePackageVersionAsync(Guid feedId, string packageName, string version, PackageVersionDetails details) =>
        (await _artifactsClient.UpdatePackageVersionAsync(feedId, packageName, version, details)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeletePackageAsync(Guid feedId, string packageName, string version) =>
        (await _artifactsClient.DeletePackageAsync(feedId, packageName, version)).EnsureSuccess(_logger);
    ...
    public async Task<Stream> DownloadPackageAsync(Guid feedId, string packageName, string version) =>
        (await _artifactsClient.DownloadPackageAsync(feedId, packageName, version)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<FeedPermission>> GetFeedPermissionsAsync(Guid feedId) => 
        (await _artifactsClient.GetFeedPermissionsAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<FeedView> CreateFeedViewAsync(Guid feedId, FeedView feedView) =>
        (await _artifactsClient.CreateFeedViewAsync(feedId, feedView)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<FeedView>> ListFeedViewsAsync(Guid feedId) => 
        (await _artifactsClient.ListFeedViewsAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteFeedViewAsync(Guid feedId, string viewId) =>
        (await _artifactsClient.DeleteFeedViewAsync(feedId, viewId)).EnsureSuccess(_logger);
    ...
    public async Task<bool> SetUpstreamingBehaviorAsync(Guid feedId, string packageName, UpstreamingBehavior behavior) =>
        (await _artifactsClient.SetUpstreamingBehaviorAsync(feedId, packageName, behavior)).EnsureSuccess(_logger);
    ...
    public async Task<UpstreamingBehavior> GetUpstreamingBehaviorAsync(Guid feedId, string packageName) =>
        (await _artifactsClient.GetUpstreamingBehaviorAsync(feedId, packageName)).EnsureSuccess(_logger);
    ...
    public async Task<FeedRetentionPolicy> GetRetentionPolicyAsync(Guid feedId) =>
        (await _artifactsClient.GetRetentionPolicyAsync(feedId)).EnsureSuccess(_logger);
    ...
    public async Task<FeedRetentionPolicy> SetRetentionPolicyAsync(Guid feedId, FeedRetentionPolicy policy) =>
        (await _artifactsClient.SetRetentionPolicyAsync(feedId, policy)).EnsureSuccess(_logger);
}
