...
public class ReposTools(IReposClient reposClient, ILogger<ReposTools> logger)
{
    ...
    public async Task<GitPullRequest> GetPullRequestAsync(string repositoryId, int pullRequestId, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetPullRequestAsync(repositoryId, pullRequestId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequest> CompletePullRequestAsync(string repositoryId, int pullRequestId, bool squashMerge = false, bool deleteSourceBranch = false, GitCommitRef? lastMergeSourceCommit = null, string? commitMessage = null, CancellationToken cancellationToken = default) =>
        (await _reposClient.CompletePullRequestAsync(repositoryId, pullRequestId, squashMerge, deleteSourceBranch, lastMergeSourceCommit, commitMessage, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequest> AbandonPullRequestAsync(string repositoryId, int pullRequestId, CancellationToken cancellationToken = default) =>
        (await _reposClient.AbandonPullRequestAsync(repositoryId, pullRequestId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitPullRequest>> ListPullRequestsAsync(string repositoryId, PullRequestSearchOptions options, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListPullRequestsAsync(repositoryId, options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<Guid> CreateRepositoryAsync(string repositoryName, CancellationToken cancellationToken = default) =>
        (await _reposClient.CreateRepositoryAsync(repositoryName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitRepository> GetRepositoryAsync(Guid repositoryId, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetRepositoryAsync(repositoryId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitRepository> GetRepositoryByNameAsync(string repositoryName, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetRepositoryByNameAsync(repositoryName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitRepository>> ListRepositoriesAsync(CancellationToken cancellationToken = default) =>
        (await _reposClient.ListRepositoriesAsync(cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<List<GitRefUpdateResult>> CreateBranchAsync(string repositoryId, string newRefName, string baseCommitSha, CancellationToken cancellationToken = default) =>
        (await _reposClient.CreateBranchAsync(repositoryId, newRefName, baseCommitSha, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitRef> GetBranchAsync(string repositoryId, string branchName, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetBranchAsync(repositoryId, branchName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitCommitRef>> SearchCommitsAsync(string repositoryId, GitQueryCommitsCriteria searchCriteria, int top = 100, CancellationToken cancellationToken = default) =>
        (await _reposClient.SearchCommitsAsync(repositoryId, searchCriteria, top, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitCommitRef>> GetLatestCommitsAsync(string projectName, string repositoryName, string branchName, int top = 1, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetLatestCommitsAsync(projectName, repositoryName, branchName, top, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<string> CommitAddFileAsync(FileCommitOptions options, CancellationToken cancellationToken = default) =>
        (await _reposClient.CommitAddFileAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitAnnotatedTag> CreateTagAsync(TagCreateOptions options, CancellationToken cancellationToken = default) =>
        (await _reposClient.CreateTagAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitAnnotatedTag> GetTagAsync(string repositoryId, string objectId, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetTagAsync(repositoryId, objectId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitRefUpdateResult> DeleteTagAsync(string repositoryId, string tagName, CancellationToken cancellationToken = default) =>
        (await _reposClient.DeleteTagAsync(repositoryId, tagName, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> AddReviewersAsync(string repositoryId, int pullRequestId, (string localId, string name)[] reviewers, CancellationToken cancellationToken = default) =>
        (await _reposClient.AddReviewersAsync(repositoryId, pullRequestId, reviewers, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> RemoveReviewersAsync(string repositoryId, int pullRequestId, CancellationToken cancellationToken = default, params string[] reviewerIds) =>
        (await _reposClient.RemoveReviewersAsync(repositoryId, pullRequestId, cancellationToken, reviewerIds)).EnsureSuccess(_logger);
    ...
    public async Task<IdentityRefWithVote> SetReviewerVoteAsync(string repositoryId, int pullRequestId, string reviewerId, short vote, CancellationToken cancellationToken = default) =>
        (await _reposClient.SetReviewerVoteAsync(repositoryId, pullRequestId, reviewerId, vote, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<AzureDevOpsActionResult<IList<Microsoft.TeamFoundation.Core.WebApi.WebApiTagDefinition>>> AddLabelsAsync(string repository, int pullRequestId, CancellationToken cancellationToken = default, params string[] labels) =>
        await _reposClient.AddLabelsAsync(repository, pullRequestId, cancellationToken, labels);
    ...
    public async Task<bool> AddReviewerAsync(string repositoryId, int pullRequestId, (string localId, string name) reviewer, CancellationToken cancellationToken = default) =>
        (await _reposClient.AddReviewerAsync(repositoryId, pullRequestId, reviewer, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<int> CreateCommentThreadAsync(CommentThreadOptions commentThreadOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.CreateCommentThreadAsync(commentThreadOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeleteCommentAsync(string repositoryId, int pullRequestId, int threadId, int commentId, CancellationToken cancellationToken = default) =>
        (await _reposClient.DeleteCommentAsync(repositoryId, pullRequestId, threadId, commentId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<Comment> EditCommentAsync(CommentEditOptions commentEditOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.EditCommentAsync(commentEditOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequest> EnableAutoCompleteAsync(string repositoryId, int pullRequestId, string displayName, string localId, GitPullRequestCompletionOptions gitPullRequestCompletionOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.EnableAutoCompleteAsync(repositoryId, pullRequestId, displayName, localId, gitPullRequestCompletionOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitCommitDiffs> GetCommitDiffAsync(string repositoryId, string baseSha, string targetSha, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetCommitDiffAsync(repositoryId, baseSha, targetSha, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequest> UpdatePullRequestAsync(string repositoryId, int pullRequestId, PullRequestUpdateOptions pullRequestUpdateOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.UpdatePullRequestAsync(repositoryId, pullRequestId, pullRequestUpdateOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitPullRequestIteration>> ListIterationsAsync(string repositoryId, int pullRequestId, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListIterationsAsync(repositoryId, pullRequestId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<WebApiTagDefinition>> GetPullRequestLabelsAsync(string repository, int pullRequestId, CancellationToken cancellationToken = default) =>
        (await _reposClient.GetPullRequestLabelsAsync(repository, pullRequestId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> RemoveLabelAsync(string repositoryId, int pullRequestId, string label, CancellationToken cancellationToken = default) =>
        (await _reposClient.RemoveLabelAsync(repositoryId, pullRequestId, label, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitPullRequest>> ListPullRequestsByProjectAsync(PullRequestSearchOptions pullRequestSearchOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListPullRequestsByProjectAsync(pullRequestSearchOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitPullRequest>> ListPullRequestsByLabelAsync(string repositoryId, string labelName, PullRequestStatus pullRequestStatus, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListPullRequestsByLabelAsync(repositoryId, labelName, pullRequestStatus, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<GitPullRequestCommentThread>> ListPullRequestThreadsAsync(string repositoryId, int pullRequestId, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListPullRequestThreadsAsync(repositoryId, pullRequestId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<Comment>> ListPullRequestThreadCommentsAsync(string repositoryId, int pullRequestId, int threadId, CancellationToken cancellationToken = default) =>
        (await _reposClient.ListPullRequestThreadCommentsAsync(repositoryId, pullRequestId, threadId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<int> ReplyToCommentThreadAsync(CommentReplyOptions commentReplyOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.ReplyToCommentThreadAsync(commentReplyOptions, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequestCommentThread> ResolveCommentThreadAsync(string repositoryId, int pullRequestId, int threadId, CancellationToken cancellationToken = default) =>
        (await _reposClient.ResolveCommentThreadAsync(repositoryId, pullRequestId, threadId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<GitPullRequestStatus> SetPullRequestStatusAsync(string repositoryId, int pullRequestId, PullRequestStatusOptions pullRequestStatusOptions, CancellationToken cancellationToken = default) =>
        (await _reposClient.SetPullRequestStatusAsync(repositoryId, pullRequestId, pullRequestStatusOptions, cancellationToken)).EnsureSuccess(_logger);
}
