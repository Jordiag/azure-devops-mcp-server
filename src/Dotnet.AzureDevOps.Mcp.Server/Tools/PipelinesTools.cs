...
public class PipelinesTools(IPipelinesClient pipelinesClient, ILogger<PipelinesTools> logger)
{
    ...
    public async Task<int> QueueRunAsync(BuildQueueOptions options, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.QueueRunAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<Build> GetRunAsync(int buildId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetRunAsync(buildId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<Build>> ListRunsAsync(BuildListOptions options, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.ListRunsAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> CancelRunAsync(int buildId, TeamProjectReference project, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.CancelRunAsync(buildId, project, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<int> RetryRunAsync(int buildId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.RetryRunAsync(buildId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<BuildDefinition> GetPipelineAsync(int definitionId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetPipelineAsync(definitionId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<BuildDefinitionReference>> ListDefinitionsAsync(BuildDefinitionListOptions options, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.ListDefinitionsAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<IReadOnlyList<BuildDefinitionReference>> ListPipelinesAsync(CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.ListPipelinesAsync(cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<int> CreatePipelineAsync(PipelineCreateOptions options, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.CreatePipelineAsync(options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> UpdatePipelineAsync(int definitionId, PipelineUpdateOptions options, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.UpdatePipelineAsync(definitionId, options, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> DeletePipelineAsync(int definitionId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.DeletePipelineAsync(definitionId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<List<BuildLog>> GetLogsAsync(int buildId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetLogsAsync(buildId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<BuildReportMetadata> GetBuildReportAsync(int buildId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetBuildReportAsync(buildId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<List<Change>> GetChangesAsync(int buildId, string? continuationToken = null, int top = 100, bool includeSourceChange = false, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetChangesAsync(buildId, continuationToken, top, includeSourceChange, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<List<BuildDefinitionRevision>> GetDefinitionRevisionsAsync(int definitionId, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.GetDefinitionRevisionsAsync(definitionId, cancellationToken)).EnsureSuccess(_logger);
    ...
    public async Task<bool> UpdateBuildStageAsync(int buildId, string stageName, StageUpdateType status, bool forceRetryAllJobs = false, CancellationToken cancellationToken = default) =>
        (await _pipelinesClient.UpdateBuildStageAsync(buildId, stageName, status, forceRetryAllJobs, cancellationToken)).EnsureSuccess(_logger);
}
